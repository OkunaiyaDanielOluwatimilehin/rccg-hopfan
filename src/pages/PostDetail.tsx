  ...
  return (
    <div className="pt-20 min-h-screen bg-cream">
      <Seo
        ...
        image={post.image_url || '/Rccg_logo.png'}
        ...
        <div className="bg-white border border-stone-100 shadow-2xl overflow-hidden">
          ...
          <div className="p-12 md:p-24 max-w-4xl mx-auto">
            ...
            <div className="mt-20 sm:mt-32 pt-10 sm:pt-16 border-t border-stone-100 flex justify-end">
              <button
                onClick={handleShare}
                className="inline-flex items-center justify-center gap-3 px-4 sm:px-8 py-4 bg-stone-50 text-stone-600 font-bold rounded-xl hover:bg-stone-100 transition-all w-full sm:w-auto"
              >
