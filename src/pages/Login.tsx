...
import { Mail, Lock, Loader2, ArrowRight, Church, User, Sparkles } from 'lucide-react';
        ...
        <div className="absolute bottom-20 left-20 right-20 text-white space-y-6">
          ...
          >
            ...
            <p className="text-xl text-stone-200 max-w-md mt-4">
              Sign in to access your dashboard, save sermons, and stay connected with our church family.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-stone-50">
        ...
        >
          <div className="text-center lg:text-left space-y-4">
            ...
            <div>
              <h2 className="text-3xl font-serif font-bold text-stone-900">Sign In</h2>
              <p className="text-stone-500 mt-2">Enter your credentials to access your account</p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link to="/forgot-password" title="Forgot Password" className="text-xs font-bold text-accent hover:underline uppercase tracking-widest">
                    Forgot?
                  </Link>
                </div>
                <div className="relative">
          ...
          <div className="text-center pt-4">
            <p className="text-stone-600 text-sm">
              ...
              <Link to="/register" className="text-accent font-bold hover:underline uppercase tracking-widest text-xs ml-1">
                Create Account
              </Link>
            </p>
          </div>
