...
import { SiteSettings, Department, Leadership, GalleryItem, Devotional, NewsletterSubscription, ChurchEvent } from '../../types';
...
export default function AdminSettings() {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      const siteSettingsPayload = {
        ...
        giving_bank_name: (settings as any).giving_bank_name ?? null,
        giving_account_name: (settings as any).giving_account_name ?? null,
        giving_account_number: (settings as any).giving_account_number ?? null,
  ...
  const handleAddDevotional = () => {
    const newDev = { id: `tmp-${Date.now()}`, title: 'New Devotional', content: '', author: 'Pastor', date: new Date().toISOString().split('T')[0] } as Devotional;
    ...
    <div className="p-8 max-w-6xl mx-auto space-y-12">
      <header className="flex justify-between items-center">
        ...
        <button
          ...
          disabled={saving}
          className="flex items-center gap-2 bg-primary text-white px-6 py-2 rounded-lg font-bold hover:bg-primary/90 disabled:opacity-50 transition-all"
        >
      ...
      {/* Typography (Quick) */}
      <section className="bg-white p-10 border border-stone-200 shadow-sm space-y-8">
      ...
      <section className="bg-white p-10 border border-stone-200 shadow-sm space-y-8">
        ...
        <p className="text-sm text-stone-500 max-w-3xl">
          Add your bank details here for now. The homepage will show these details in the giving card and let users copy the account number.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-3">
            ...
            <input
              type="text"
              value={(settings as any)?.giving_bank_name || ''}
              onChange={e => setSettings(prev => prev ? { ...prev, giving_bank_name: e.target.value } : null)}
              className="w-full p-4 border border-stone-200 focus:ring-4 focus:ring-accent/10 outline-none transition-all"
          ...
          <div className="space-y-3">
            ...
            <input
              type="text"
              value={(settings as any)?.giving_account_name || ''}
              onChange={e => setSettings(prev => prev ? { ...prev, giving_account_name: e.target.value } : null)}
              className="w-full p-4 border border-stone-200 focus:ring-4 focus:ring-accent/10 outline-none transition-all"
          ...
          <div className="space-y-3">
            ...
            <input
              type="text"
              value={(settings as any)?.giving_account_number || ''}
              onChange={e => setSettings(prev => prev ? { ...prev, giving_account_number: e.target.value } : null)}
              className="w-full p-4 border border-stone-200 focus:ring-4 focus:ring-accent/10 outline-none transition-all"
      ...
      <section className="bg-white p-10 border border-stone-200 shadow-sm space-y-8">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 text-emerald-600 font-bold hover:underline uppercase tracking-widest text-sm"
          >
        ...
        <div className="space-y-8">
          {devotionals.map((dev, index) => (
            <div key={dev.id} className="p-8 border border-stone-100 space-y-6 relative group bg-stone-50/50">
              <button
                onClick={() => {
                  setDevotionals(devotionals.filter(d => d.id !== dev.id));
                }}
                className="absolute top-6 right-6 p-2 text-stone-400 hover:text-red-600 opacity-0 group-hover:opacity-100 transition-all"
              >
                <Trash2 className="w-5 h-5" />
              </button>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    value={dev.title}
                    onChange={e => {
                      const newDevs = [...devotionals];
                      newDevs[index].title = e.target.value;
                      setDevotionals(newDevs);
                    }}
                    className="w-full p-3 bg-white border border-stone-200 outline-none focus:ring-4 focus:ring-emerald-500/10"
                  />
                </div>
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    onChange={e => {
                      const newDevs = [...devotionals];
                      newDevs[index].date = e.target.value;
                      setDevotionals(newDevs);
                    }}
                    className="w-full p-3 bg-white border border-stone-200 outline-none focus:ring-4 focus:ring-emerald-500/10"
                  />
              ...
              <div className="space-y-3">
                <label className="text-xs font-bold text-stone-500 uppercase tracking-widest">Content</label>
                <textarea
                  value={dev.content}
                  onChange={e => {
                    const newDevs = [...devotionals];
                    newDevs[index].content = e.target.value;
                    setDevotionals(newDevs);
                  }}
                  rows={6}
                  className="w-full p-4 bg-white border border-stone-200 outline-none focus:ring-4 focus:ring-emerald-500/10"
                />
              </div>
            </div>
          ))}
      ...
      <section className="bg-white p-10 border border-stone-200 shadow-sm space-y-8">
        ...
        <div className="space-y-8">
          {events.map((event, index) => (
            <div key={event.id} className="p-8 border border-stone-100 space-y-6 relative group bg-stone-50/50">
              <button
                onClick={() => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full p-3 bg-white border border-stone-200 outline-none focus:ring-4 focus:ring-accent/10"
                  />
                </div>
                <div className="space-y-3">
                  <label className="text-xs font-bold text-stone-500 uppercase tracking-widest">Date</label>
                  <input
                    ...
                    onChange={e => {
                      const newEvents = [...events];
                      newEvents[index].event_date = e.target.value;
                      setEvents(newEvents);
                    }}
                    className="w-full p-3 bg-white border border-stone-200 outline-none focus:ring-4 focus:ring-accent/10"
                  />
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    onChange={e => {
                      const newEvents = [...events];
                      newEvents[index].event_time = e.target.value;
                      setEvents(newEvents);
                    }}
                    className="w-full p-3 bg-white border border-stone-200 outline-none focus:ring-4 focus:ring-accent/10"
                  />
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full p-4 bg-white border border-stone-200 outline-none focus:ring-4 focus:ring-accent/10"
                />
              </div>
              <div className="space-y-3">
                <label className="text-xs font-bold text-stone-500 uppercase tracking-widest">Thumbnail URL (Cloudflare)</label>
                <input
                  type="url"
                  value={event.image_url || ''}
                  onChange={e => {
                    const newEvents = [...events];
                    newEvents[index] = { ...newEvents[index], image_url: e.target.value };
                    setEvents(newEvents);
                  }}
                  className="w-full p-3 bg-white border border-stone-200 outline-none focus:ring-4 focus:ring-accent/10"
                  placeholder="https://pub-xxxx.r2.dev/events/thumbnail.jpg"
                />
                {event.image_url && (
                  <div className="w-full max-w-sm aspect-video bg-stone-100 border border-stone-200 overflow-hidden">
